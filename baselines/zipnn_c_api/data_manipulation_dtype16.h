...
uint32_t reorder_float_bits_dtype16(float number);
void reorder_all_floats_dtype16(uint8_t *src, size_t len);
...
uint32_t revert_float_bits_dtype16(float number);
void revert_all_floats_dtype16(uint8_t *src, size_t len);
