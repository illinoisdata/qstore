...
./baseline2_zstd encode fp16 "${BASE_MODEL_NAME}"
sudo bash ../drop_cache.sh
./baseline2_zstd decode fp16 "${BASE_MODEL_NAME}"

echo "----------------------- FP16-INT8 -----------------------"
sudo bash ../drop_cache.sh
./baseline2_zstd encode fp16-int8 "${BASE_MODEL_NAME}"
sudo bash ../drop_cache.sh
./baseline2_zstd decode fp16-int8 "${BASE_MODEL_NAME}"

echo "----------------------- BF16 -----------------------"
sudo bash ../drop_cache.sh
./baseline2_zstd encode bf16 "${BASE_MODEL_NAME}"
sudo bash ../drop_cache.sh
./baseline2_zstd decode bf16 "${BASE_MODEL_NAME}"

echo "----------------------- BF16-INT8 -----------------------"
sudo bash ../drop_cache.sh
./baseline2_zstd encode bf16-int8 "${BASE_MODEL_NAME}"
sudo bash ../drop_cache.sh
./baseline2_zstd decode bf16-int8 "${BASE_MODEL_NAME}"