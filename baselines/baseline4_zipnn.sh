...
./baseline4_zipnn encode fp16 "${BASE_MODEL_NAME}"

echo "--------------------- BF16 encode ---------------------"
sudo bash ../drop_cache.sh
./baseline4_zipnn encode bf16 "${BASE_MODEL_NAME}"

echo "--------------------- FP16 decode ---------------------"
sudo bash ../drop_cache.sh
./baseline4_zipnn decode fp16 "${BASE_MODEL_NAME}"

echo "--------------------- BF16 decode ---------------------"
sudo bash ../drop_cache.sh
./baseline4_zipnn decode bf16 "${BASE_MODEL_NAME}"